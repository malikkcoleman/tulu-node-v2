...
const addVehicleStepTen = document.querySelector('.addVehicleStepNine');
...
function goBack(){
    if (addVehicleStepCount == 2) {
        const addVehicleStepOne = document.querySelector('.addVehicleStepOne');
        const addVehicleStepTwo = document.querySelector('.addVehicleStepTwo');
        addVehicleStepOne.style = "display:Flex; opacity:1;";
        addVehicleStepTwo.style = "display:none;";
        addVehicleStepCount--;
        ...
        const addVehicleStepTwo = document.querySelector('.addVehicleStepTwo');
        const addVehicleStepThree = document.querySelector('.addVehicleStepThree');
        addVehicleStepTwo.style = "display:Flex; opacity:1;";
        ...
        const addVehicleStepThree = document.querySelector('.addVehicleStepThree');
        const addVehicleStepFour = document.querySelector('.addVehicleStepFour');
        addVehicleStepThree.style = "display:Flex; opacity:1;";
        ...
        const addVehicleStepFour = document.querySelector('.addVehicleStepFour');
        const addVehicleStepFive = document.querySelector('.addVehicleStepFive');
        addVehicleStepFour.style = "display:Flex; opacity:1;";
        ...
        const addVehicleStepFive = document.querySelector('.addVehicleStepFive');
        const addVehicleStepSix = document.querySelector('.addVehicleStepSix');
        addVehicleStepFive.style = "display:Flex; opacity:1;";
        ...
        const addVehicleStepSix = document.querySelector('.addVehicleStepSix');
        const addVehicleStepSeven = document.querySelector('.addVehicleStepSeven');
        addVehicleStepSix.style = "display:Flex; opacity:1;";
        ...
        const addVehicleStepSeven = document.querySelector('.addVehicleStepSeven');
        const addVehicleStepEight = document.querySelector('.addVehicleStepEight');
        addVehicleStepSeven.style = "display:Flex; opacity:1;";
        ...
        const addVehicleStepEight = document.querySelector('.addVehicleStepEight');
        const addVehicleStepNine = document.querySelector('.addVehicleStepNine');
        addVehicleStepEight.style = "display:Flex; opacity:1;";
        addVehicleStepNine.style = "display:none;";
        document.querySelector('#RetailPrice').style = "display:none !important;"
        console.log('tangina');
        ...
        const addVehicleStepNine = document.querySelector('.addVehicleStepNine');
        const addVehicleStepTen = document.querySelector('.addVehicleStepTen');
        addVehicleStepNine.style = "display:Flex; opacity:1;";
        addVehicleStepTen.style = "display:none;";
        addVehicleStepCount--;
        //setTimeout(ShowAddVehicleStepTen, 600);
    }
    else if (addVehicleStepCount == 11) {
        const addVehicleStepTen = document.querySelector('.addVehicleStepTen');
        const vehicleAdded = document.querySelector('.vehicleAdded');
        addVehicleStepTen.style = "display:Flex; opacity:1;";
        vehicleAdded.style = "display:none;";
        addVehicleStepCount--;
        //setTimeout(AddedSuccessful, 600);
    }
    else if (addVehicleStepCount == 12) {
        const vehicleAdded = document.querySelector('.vehicleAdded');
        vehicleAdded.style = "display:Flex; opacity:1;";
        //setTimeout(AddingDone, 600);
    }
}

const AddVehicleStep = () => {
    console.log(addVehicleStepCount);
    if(addVehicleStepCount == 1){
        ...
        const addVehicleStepTen = document.querySelector('.addVehicleStepTen');
        const vehicleAdded = document.querySelector('.vehicleAdded');
        addVehicleStepTen.style = "display:Flex; opacity:0; transition:0.5s;";
...
const ShowAddVehicleStepTen = () => {
    const addVehicleStepTen = document.querySelector('.addVehicleStepTen');
    const addVehicleStepNine = document.querySelector('.addVehicleStepNine');
    addVehicleStepTen.style = "display:Flex; opacity:1; transition:0.5s;";
    addVehicleStepNine.style = "display:none;";
}
...
const addAnotherImage = () =>{
    const fileBtn = document.querySelector(`#photos-inputAgain`);
    fileBtn.click();
}
...
const addDpImage = () =>{
    const fileBtn = document.querySelector(`#dp-photos-input`);
    fileBtn.click();
}
